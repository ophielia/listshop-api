...
delete from tag_relation where child_tag_id in (888999, 8881009, 8881019, 9991019);
delete from food_categories where category_id in (3,13,18);
delete from foods where food_id in (9000, 9001, 9002, 9003, 9004);
delete from tag where tag_id in (888999, 8881009, 8881019, 9991019);
