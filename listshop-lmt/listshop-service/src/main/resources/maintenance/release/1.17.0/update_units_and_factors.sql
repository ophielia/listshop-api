...
insert into units (unit_id, name, type, subtype, is_list_unit, is_dish_unit, is_liquid, is_tag_specific, excluded_domains) values (1051, 'teaspoon (fluid) (UK)', 'UK', 'VOLUME',FALSE, TRUE,TRUE,FALSE,'');
insert into units (unit_id, name, type, subtype, is_list_unit, is_dish_unit, is_liquid, is_tag_specific, excluded_domains) values (1052, 'tablespoon (fluid) (UK)', 'UK', 'VOLUME',FALSE, TRUE,TRUE,FALSE,'');
