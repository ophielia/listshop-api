--
-- Name: copy_dishes(integer, integer); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.copy_dishes(integer, integer) RETURNS integer
    LANGUAGE plpgsql
AS
$_$
DECLARE
...
ALTER FUNCTION public.copy_dishes(integer, integer) OWNER TO bank;

--
-- Name: deleteallperishable(); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.deleteallperishable() RETURNS integer
    LANGUAGE plpgsql
AS
$$
BEGIN
...
ALTER FUNCTION public.deleteallperishable() OWNER TO bank;

--
-- Name: movedish(integer); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.movedish("pFirstId" integer) RETURNS integer
    LANGUAGE plpgsql
AS
$_$
DECLARE
...
ALTER FUNCTION public.movedish("pFirstId" integer) OWNER TO bank;

--
-- Name: movelistcategory(integer); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.movelistcategory("pFirstId" integer) RETURNS integer
    LANGUAGE plpgsql
AS
$_$
DECLARE
...
BEGIN
    ...
    FOR pCat IN select * from list_category o
        LOOP
...
ALTER FUNCTION public.movelistcategory("pFirstId" integer) OWNER TO bank;

--
-- Name: movelistlayout(integer); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.movelistlayout("pFirstId" integer) RETURNS integer
    LANGUAGE plpgsql
AS
$_$
DECLARE
...
BEGIN
    ...
    FOR pRec IN select * from list_category o
        LOOP
...
ALTER FUNCTION public.movelistlayout("pFirstId" integer) OWNER TO bank;

--
-- Name: movetag(integer); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.movetag("pFirstInt" integer DEFAULT 100000) RETURNS integer
    LANGUAGE plpgsql
AS
$_$
DECLARE
...
ALTER FUNCTION public.movetag("pFirstInt" integer) OWNER TO bank;

--
-- Name: movetagsattelites(integer); Type: FUNCTION; Schema: public; Owner: bank
--

CREATE FUNCTION public.movetagsattelites("pFirstId" integer) RETURNS integer
    LANGUAGE plpgsql
AS
$_$
DECLARE
...
BEGIN
    i = 0;
    FOR pRec IN select * from tag_relation o
        LOOP
...
-- and now - update the dish itself
    ...
    i = 0;
    FOR pRec IN select * from tag_search_group o
        LOOP
...
-- and now - update the dish itself
    ...
    i = 0;
    FOR pRec IN select * from list_tag_stats o
        LOOP
...
ALTER FUNCTION public.movetagsattelites("pFirstId" integer) OWNER TO bank;
