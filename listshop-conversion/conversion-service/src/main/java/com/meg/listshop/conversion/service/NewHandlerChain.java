...
public class NewHandlerChain {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NewHandlerChain.class);
    private final ConversionHandler handler;

    private NewHandlerChain nextLink;

    public NewHandlerChain(ConversionHandler handler) {
    ...
    public void setNextLink(NewHandlerChain nextLink) {
